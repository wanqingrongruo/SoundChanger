...
- (void)main {
    ...
    try {
        ...
        CNLog(@"sampleRate: %d tempoChangeValue:%d  pitchSemiTones:%f  rateChange:%d",audioSampleRate,audioTempoChange,audioPitch,audioRate);
